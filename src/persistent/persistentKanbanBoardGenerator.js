  ...
  generate: () => {
    const columns = {
      "16244686152977938": {
        ...
        limit: 0,
        items: [
          { id: "27833411730699775", title: "Implement ConfirmButton component for ProductModal", description: "A ConfirmButton component should be implemented to allow confirming selected product features in ProductModal.", assignedIds: [], priority: "", isLocked: false },
          { id: "5900400848369358", title: "Redesign ProductPage to allow more space for visualization of products", description: "The ProductPage needs a redesign to allow more space for visualization of products.", assignedIds: [], priority: "", isLocked: false }
        ]
      },
      "851904397063169": {
        id: "851904397063169",
      ...
      "13372358665210715": {
        ...
        markedAsDone: true,
        items: [
          { id: "3489073798557012", title: "Show notification after successfull order confirmation", description: "The system should be able to show relevant notification after the user successfully confirm current order.", assignedIds: ["7071360811547569", "23179223528758852", "8944354170460678"], priority: "medium", isLocked: false }
        ]
      }
    }
